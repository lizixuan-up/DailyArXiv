...
keywords = ["Diffusion Model for Recommendation", "Multimodal Recommender", "Representation Learning"] # TODO add more keywords
...
f_is.write("---\n")
f_is.write("**Please check the [Github](https://github.com/lizixuan-up/DailyArXiv) page for a better reading experience and more papers.**\n\n")
